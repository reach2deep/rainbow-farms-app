...
//     heroService = TestBed.get(TransactionService);
//   });
...
//     expect(TransactionService.checkIfUserCanVote()).toBe(false);
//     heroService.createHero({
//       'name': 'test',
//       'alterEgo': 'test'
//     }).subscribe((hero) => {
...
//     localStorage.setItem('votes', String(0));
//     expect(TransactionService.checkIfUserCanVote()).toBe(true);
//     heroService.createHero({
//       'name': 'test',
//       'alterEgo': 'test'
//     }).subscribe((hero) => {
